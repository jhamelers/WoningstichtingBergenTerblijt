...
(function($){
	$.fn.extend({
		panelGallery: function(options)
		{
			...
			{
				sections : 0, /*3*/
				imageTransitionDelay: 5000, /*3000*/
				sectionTransitionDelay: 700, /*700*/
				startDelay: 2000, /*2000*/
				repeat : true,
				direction : "lr"
			};
		var options = $.extend(defaults, options);
    		...
    		return this.each(function() {
				...
				$("img", obj).css({ 'top': '0px', 'left': '30%', 'float': 'right' }); // Set the position of all images in the container
